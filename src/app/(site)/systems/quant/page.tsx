...
export const metadata: Metadata = createPageMetadata(
  routeSeoMetadata["/systems/quant"],
);

const pageJsonLd = createRouteWebPageJsonLd("/systems/quant", [
  { name: "Home", path: "/" },
  { name: "Systems & Products", path: "/systems" },
  { name: "Emerald Quant System", path: "/systems/quant" },
]);

type QuantSystemPageProps = Readonly<{
  searchParams?: Promise<{
    configuration?: string | string[];
  }>;
}>;

export default async function QuantSystemPage({
  searchParams,
}: QuantSystemPageProps) {
