  ...
  return (
    <article className="surface-elevated flex min-h-full flex-col rounded-lg p-5 md:p-6">
      ...
      <div className="mt-auto pt-6">
        <Link
          href="/systems/quant"
          className="focus-emerald transition-standard text-emerald hover:text-foreground inline-flex min-h-10 items-center text-sm font-semibold underline decoration-[var(--border-emerald)] underline-offset-4"
        >
