...
export function RecoveryHero({ product, platforms, asset }: RecoveryHeroProps) {
            ...
            {asset ? (
              ...
              <div className="surface-data flex aspect-[16/10] min-h-72 items-center justify-center p-6">
                <p className="type-body text-muted-foreground text-center">
                  Trader entry followed by configured trade management
                </p>
              </div>
            )}
            <figcaption className="border-t border-[var(--border)] p-4">
              <div className="flex flex-wrap items-center gap-2">
                <Badge variant="neutral">Product Architecture</Badge>
              </div>
              <p className="text-muted-foreground mt-3 text-sm leading-6">
                Conceptual architecture, not a platform screenshot or
                performance record. Trader entry precedes configured trade
                management.
              </p>
            </figcaption>
          </figure>
